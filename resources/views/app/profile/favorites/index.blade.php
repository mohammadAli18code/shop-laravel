                        ...
                        @foreach ($favorites as $favorite)
                            <div class="my-2 p-2 md:p-4 bg-white rounded-2xl border group swiper-slide-next">
                                <div class="flex justify-between relative">
                                    @if (!$favorite->discount_percentage == 0)
                                        <div
                                            class="bg-sky-500 rounded-full w-8 h-8 pt-1 text-white flex items-center justify-center text-xs">
                                            % {{ round($favorite->discount_percentage) }}
                                        </div>
                                    @endif
                                ...
                                <div class="image-box mb-6 ">
                                    <img class="max-w-52 mx-auto"
                                        src="{{ asset($favorite->thumbnail->path ?? 'app/images/no-image.png') }}"
                                        alt="">
                                </div>
                                <div class="space-y-5">
                                    <span class="mb-2 h-8 md:h-10 flex justify-between">
                                        <a href="{{ route('app.product.show', ['product' => $favorite->id]) }}"
                                    ...
                                    <!-- <a href="{{ url('app.cart.add' . $favorite->product_id) }}" class="flex items-center justify-center gap-x-1 text-sm w-full py-2 px-2 rounded-lg text-white bg-gradient-to-bl from-sky-500 to-sky-700 hover:opacity-80 transition">
                                                                                  افزودن به سبد خرید
                                                                                </a> -->
                                </div>
                            </div>
