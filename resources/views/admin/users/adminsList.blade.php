    ...
    <div class="main-content font-size-13">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item is-active" href="{{ route('admin.users/admins') }}">ادمین ها</a>
                ...
                <tbody>
                    ...
                    @foreach ($admins as $admin)
                        <tr role="row" class="">
                            ...
                            @elseif($admin->is_active == 2)
                                <td class="text-success">تایید شده</td>
                            @endif
                            <td>
                                <a href="{{ route('admin/admins/delete/' . $admin->id) }}" class="item-delete mlg-15"
                                    title="حذف"></a>
                                <a href="{{ route('admin/admins/confirm/' . $admin->id) }}" class="item-confirm mlg-15"
                                    title="تایید"></a>
                                <a href="{{ route('admin/admins/not-confirm/' . $admin->id) }}" class="item-reject mlg-15"
                                    title="رد"></a>
                                <a href="edit-user.html" target="_blank" class="item-eye mlg-15" title="مشاهده"></a>
                                <a href="{{ route('admin/profile/admin/edit/' . $admin->id) }}" class="item-edit "
                                    title="ویرایش"></a>
                            </td>
                        </tr>
                    @endforeach
