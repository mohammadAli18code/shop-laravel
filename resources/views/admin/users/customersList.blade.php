    ...
    <div class="main-content font-size-13">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item is-active" href="{{ route('admin.users/customers') }}">مشتریان</a>
                ...
                <tbody>
                    @foreach ($customers as $customer)
                        <tr role="row" class="">
                            ...
                            @endif
                            <td>
                                <a href="{{ route('admin/customers/delete/' . $customer->id) }}" class="item-delete mlg-15"
                                    title="حذف"></a>
                                <a href="{{ route('admin/customers/confirm/' . $customer->id) }}"
                                    class="item-confirm mlg-15" title="تایید"></a>
                                <a href="{{ route('admin/customers/not-confirm/' . $customer->id) }}"
                                    class="item-reject mlg-15" title="رد"></a>
                                <a href="edit-user.html" target="_blank" class="item-eye mlg-15" title="مشاهده"></a>
                                <a href="{{ route('admin/profile/customer/edit/' . $customer->id) }}" class="item-edit "
                                    title="ویرایش"></a>
                            </td>
                        </tr>
                    @endforeach
